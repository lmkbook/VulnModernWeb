...
Para configurar correctamente la base de datos y editar los archivos sin inconvenientes, por favor consulta la documentación [`configurebd`](../../VulnModernWeb/docs/databases/configurebd.md).
